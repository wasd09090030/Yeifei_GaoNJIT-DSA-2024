...
public class Algorithms {
    ...
    interface  InnerAlgorithms {
        boolean test(Object element);

    }

    public static <K extends Comparable<K>,V> int partitionByRule(Pair<K, V>[] pairs, int count , InnerAlgorithms test01) {

        while ( test01.test(pairs[count-1].getValue())== true){
            count--;
